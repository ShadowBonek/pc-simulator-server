...
const updateLocal = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.files.length > 0) {
        ...
        if (fs_1.default.existsSync(`${pathSave}${imageM}`) && imageM !== "") {
            fs_1.default.unlinkSync(`${pathSave}${imageM}`);
            console.log("ImageM deleted!");
        }
        if (fs_1.default.existsSync(`${pathSave}${imageS}`) && imageS !== "") {
            fs_1.default.unlinkSync(`${pathSave}${imageS}`);
