...
const ssdModel_1 = require("./ssdModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const components = yield ssdModel_1.ssdModel.findAndCountAll({
            where: {
                [Op.or]: [
