...
const ramModel_1 = require("./ramModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const components = yield ramModel_1.ramModel.findAndCountAll({
            where: {
                [Op.or]: [
                ...
                [Op.and]: [
                    ...
                    { memory_size: memory_size === "" ? { [Op.like]: "%" + memory_size + "%" } : memory_size },
                    { ram_type: ram_type === "" ? { [Op.like]: "%" + ram_type + "%" } : ram_type },
                    //!Required
