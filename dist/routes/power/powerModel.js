...
exports.powerModel = database_1.sequelize.define("powers", {
    ...
    efficiency_rating: { type: sequelize_1.DataTypes.STRING },
    wattage: { type: sequelize_1.DataTypes.INTEGER },
    form_factor: { type: sequelize_1.DataTypes.STRING },
    modular: { type: sequelize_1.DataTypes.STRING },
