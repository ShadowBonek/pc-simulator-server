...
const gpuModel_1 = require("./gpuModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //!Component
    const memory = ((_j = req.query) === null || _j === void 0 ? void 0 : _j.memory) || "";
    const memory_type = ((_k = req.query) === null || _k === void 0 ? void 0 : _k.memory_type) || "";
    console.log(req.query);
    try {
        const components = yield gpuModel_1.gpuModel.findAndCountAll({
            where: {
                [Op.or]: [
