...
const moboModel_1 = require("./moboModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // !Delete accents
    try {
        const components = yield moboModel_1.moboModel.findAndCountAll({
            where: {
                [Op.or]: [
