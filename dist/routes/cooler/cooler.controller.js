...
const coolerModel_1 = require("./coolerModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const components = yield coolerModel_1.coolerModel.findAndCountAll({
            where: {
                [Op.or]: [
