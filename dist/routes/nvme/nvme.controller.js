...
const nvmeModel_1 = require("./nvmeModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const components = yield nvmeModel_1.nvmeModel.findAndCountAll({
            where: {
                [Op.or]: [
