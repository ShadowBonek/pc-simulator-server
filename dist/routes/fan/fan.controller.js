...
const fanModel_1 = require("./fanModel");
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // !Delete accents
    try {
        const components = yield fanModel_1.fanModel.findAndCountAll({
            where: {
                [Op.or]: [
